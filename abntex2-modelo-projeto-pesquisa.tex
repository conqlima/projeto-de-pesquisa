...
% ---
\titulo{COMPARAÇÃO DA PRECISÃO DOS MÉTODOS NUMÉRICOS DE RESOLUÇÃO DE EQUAÇÕES DIFERENCIAS ORDINÁRIAS DE PASSO SIMPLES E PASSO MÚLTIPLO}
\autor{Robson Araújo Lima}
...
\preambulo{Projeto de conclusão de curso apresentado ao curso de Ciência 
...
\chapter{Projeto de Pesquisa}
	\input{capitulos/tema}
	\input{capitulos/delimitacao}
	\input{capitulos/problema}
	\input{capitulos/hipotese}
